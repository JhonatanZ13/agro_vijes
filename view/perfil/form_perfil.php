                            ...
                            <div class="mt-2 row p-2">
                                ...
                                <div class="col-md-8">
                                    <div class="cat2 text-center">
                                        ...
                                        <br>
                                        <h4><i class="fas fa-tractor"></i> <b><?php echo $obj->Consultname('rol_desc', 'rol WHERE rol_id  = ' . $rol) ?></b></h4>
                                        <br>
                                    ...
                                    <div class="text-center">
                                        <a href="<?php echo getUrl("Perfil", "Perfil", "editarPerfil", array('usu_id' => $eje['usu_id'])); ?>"> <button class="btn btn-green">Editar perfil</button></a>
