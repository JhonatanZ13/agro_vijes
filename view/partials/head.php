...
<head>
    ...
    <meta name="description" content="Contador con VueJS">
    <meta name="author" content="Jhonatan Zambrano" />
    <!-- Metadata para PWA -->

    <!-- Modificar color barra estado android-->
    <meta name="theme-color" content="#084000">
    ...
    <!-- DataTables Content  -->
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/dt-1.11.1/r-2.2.9/datatables.min.css">
