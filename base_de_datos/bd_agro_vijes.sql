...
INSERT INTO `ciudad` (`ciu_id`, `ciu_nombre`, `ciu_estado`, `dep_id`) VALUES
(1, 'Abriaquí', 1, 5),
(2, 'Acacías', 1, 50),
(3, 'Acandí', 1, 27),
(4, 'Acevedo', 1, 41),
...
CREATE TABLE `departamento` (
  `dep_id` int(10) NOT NULL,
  `dep_nombre` varchar(120) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `rol` (
  ...
  `rol_desc` varchar(120) NOT NULL,
  `rol_estado` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `rol` (`rol_id`, `rol_desc`, `rol_estado`) VALUES
(1, 'Administrador', 1),
(2, 'Agricultor', 1),
(3, 'Comprador', 1);
...
--
-- Estructura de tabla para la tabla `ruta_fotos`
--

CREATE TABLE `ruta_fotos` (
...
CREATE TABLE `tipo_producto` (
  `tipo_pro_id` int(10) NOT NULL,
  `tipo_pro_nombre` varchar(120) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tipo_producto` (`tipo_pro_id`, `tipo_pro_nombre`) VALUES
(1, 'Cafés'),
(2, 'Hortalizas'),
(3, 'Frutas'),
(4, 'Tubérculos'),
...
--
ALTER TABLE `ciudad`
  ADD CONSTRAINT `dep_id` FOREIGN KEY (`dep_id`) REFERENCES `departamento` (`dep_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
